...
namespace FE.W.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Person, "Id", "Discriminator");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,CourseId,StudentId,Grade")] Enrollment enrollment)
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Person, "Id", "Discriminator", enrollment.StudentId);
            return View(enrollment);
        }
